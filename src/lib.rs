...
mod tests {
    ...
    fn should_hash_strings() {
        ...
        let hex_hash = digest_string_claim(str_claim);
    ...
    fn should_hash_hex_claims() {
        ...
        let hex_hash = digest_hex_claim(hex_claim);
    ...
    fn should_match_string_and_hex() {
        ...
        let hex_hash1 = digest_string_claim(str_claim);
        let hex_hash2 = digest_hex_claim(hex_claim);
    ...
    fn should_hash_hex_with_0x() {
        ...
        let hex_hash1 = digest_hex_claim("1234567890123456789012345678901234567890");
        let hex_hash2 = digest_hex_claim("0x1234567890123456789012345678901234567890");
        assert_eq!(hex_hash1, hex_hash2);
    }
}
